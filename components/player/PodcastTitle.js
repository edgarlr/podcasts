...
export const PodcastTitle = ({title, wrapAt = 35, fontSize = '1em', alwaysJustify = null}) => {
    ...
    return (
      ...
      <style jsx>{`
        .main-container {
          display: flex;
          padding: 8px 0;
          justify-content: ${alwaysJustify ? alwaysJustify : 'center'};
          white-space: nowrap;
  ...
  return (
    <div className='main-container'>
      ...
      <style jsx>{`
        ...
        .main-text,  .main-text ~ .second-text {
          animation: move-text 12s linear;
          animation-delay: 5s;
        }
        .main-text:hover,  .main-text:hover ~ .second-text {
          animation: move-text 12s linear;
        }
      `}</style>
    </div>
